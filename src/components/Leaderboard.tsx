  ...
  return (
    <div className="space-y-8 animate-fade-up">
      <div>
        ...
        <p className="text-sm text-theme-muted mt-1">Top learners ranked by total XP earned.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="glass rounded-2xl p-10 text-center text-theme-muted">
          ...
          {[1, 0, 2].map((idx) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gold-700 dark:text-gold-300 font-bold text-lg sm:text-xl">{entry.xp.toLocaleString()} XP</p>
                <p className="text-[10px] uppercase tracking-wider text-theme-muted">Rank #{entry.rank}</p>
              </div>
            );
          })}
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="text-end">
                  <p className="font-bold text-gold-700 dark:text-gold-300 flex items-center gap-1">
                    <Star className="w-3.5 h-3.5 fill-current" />
                    {entry.xp.toLocaleString()}
                  </p>
                  <p className="text-[10px] uppercase tracking-wider text-theme-muted">XP</p>
                </div>
              </div>
            );
          })}
